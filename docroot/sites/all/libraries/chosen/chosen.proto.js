...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      option_el.id = this.form_field.id + "-chosen-search-result-" + option.array_index;
      if (option.title) {
    ...
    AbstractChosen.prototype.winnow_results = function(options) {
      var escapedQuery, fix, j, len, option, prefix, query, ref, regex, results, results_group, search_match, startpos, suffix, text;
    ...
    AbstractChosen.prototype.get_single_html = function() {
      return "<a class=\"chosen-single chosen-default\">\n  <span>" + this.default_text + "</span>\n  <div><b></b></div>\n</a>\n<div class=\"chosen-drop\">\n  <div class=\"chosen-search\">\n    <input class=\"chosen-search-input\" type=\"text\" autocomplete=\"off\" aria-expanded=\"false\" aria-haspopup=\"true\" aria-autocomplete=\"list\" autocomplete=\"off\" role=\"listbox\" />\n  </div>\n  <ul class=\"chosen-results\"></ul>\n</div>";
    };
  ...
  this.Chosen = (function(superClass) {
    ...
    Chosen.prototype.set_aria_labels = function() {
