<header role="banner" <?php print render($page['nav_trigger_pts']); ?>>
  <div class="container">
    <!-- Replace the following commented code with a 45px tall "mini-bar" using
         Cornell red as background and ilr_theme/images/cornell-reduced-white.svg as the logo. -->
