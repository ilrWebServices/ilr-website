function rNav(nav) {
  ...
  nav.buildMenu = function(i) {
    if (!$("#rNav-trigger").length) {
      ...
      // Overload/Use the jpanel trigger instead of rNav's default trigger to toggle the menu
...
jQuery(document).ready( function(){
  jQuery('#jPanelMenu-menu div#rNav-wrap ul.menu').attr('id', 'rNav'); rNav({ label: 'Back', width: '1768' });
});
