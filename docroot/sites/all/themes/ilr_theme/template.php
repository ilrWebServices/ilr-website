 ...
 */
function ilr_theme_form_element($variables) {
  ...
  // Added for a11y. See ilr_theme_form_element_label() for the addition of the
  // element id.
  if (in_array($element['#type'], ['radios', 'checkboxes'])) {
    $attributes['aria-labelledby'][] = $element['#id'] . '-label';
 ...
 */
function ilr_theme_form_element_label($variables) {
  $element = $variables['element'];
