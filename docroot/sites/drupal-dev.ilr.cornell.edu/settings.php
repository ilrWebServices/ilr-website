...
# For Acquia
/*
 * "Secure pages" setting. Allows session cookies to work over both http and
 * https. See: https://drupal.org/https-information#drupal-config
 */
$conf['https'] = TRUE;
$conf['habitat_environment'] = 'dev';
$conf['stage_file_proxy_origin'] = 'http://www.ilr.cornell.edu';
$conf['stage_file_proxy_origin_dir'] = 'sites/ilr.cornell.edu/files';
$conf['securepages_basepath'] = 'http://drupal-dev.ilr.cornell.edu';
$conf['securepages_basepath_ssl'] = 'https://drupal-dev.ilr.cornell.edu';
